...
namespace LoginRegister.ViewModel
{
    public partial class LoginViewModel : ViewModelBase
    {
        ...
        public LoginViewModel(IHttpJsonProvider<UserDTO> httpJsonProvider, IJuegoServiceToApi dicatadorServiceToApi)
        {
        ...
        public async Task Login()
        {
            ...
            try
            {
                ...
                if (user != null && user.IsSuccess)
                {
                    ...
                    App.Current.Properties["userName"] = userName; // ✅ Aquí se guarda
